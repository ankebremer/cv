...
## Skills
Java, SQL (Oracle and Postgres), Spring, AWS CloudFormation, AWS Lambda, AWS S3, AWS CDK, AWS SQS, DynamoDB, GraphQL, Docker, Git, Maven, Jenkins, Gradle, Spock, Agile methodologies, Stakeholder management, Mentoring and Coaching,

## Experience

### Backend developer (Volunteering position, part-time)
...
* Technical lead for a team that consisted of 6 developers and 2 business analysts
* Collaborative refinement of requirements, responsibility for project timescales, communication with stakeholders
* Line managed and mentored 5 developers
* Upgraded a legacy Java 8 code base to Java 17
